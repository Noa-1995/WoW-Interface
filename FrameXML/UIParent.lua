...
UIPanelWindows["CustomTradeSkillNewFrame"] = { area = "left",       pushable = 3,   whileDead = 1 };
UIPanelWindows["QuestMapFrame"] =		{ area = "left",	pushable = 0 };
UIPanelWindows["ToggleTalentUIFrame"] =		{ area = "left",	pushable = 0 };
...
function ToggleCustomTradeSkillFrame()
    if CustomTradeSkillNewFrame:IsShown() then
