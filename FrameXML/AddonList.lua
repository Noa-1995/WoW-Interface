...
function AddonList_UpdateInfoPanel()
    ...
    -- Estado (usando la misma función que la lista)
...
function AddonList_Update()
    ...
    for i = 1, MAX_ADDONS_DISPLAYED do
        ...
        if pos > total then
            ...
            -- Color del título (basado en estado)
            local titleColor
            ...
            -- Texto de estado y color (usando la función centralizada)
            local statusText, statusColor = GetAddonStatusInfo(enabled, loadable, reason)
            ...
            -- Manejar la textura de selección
